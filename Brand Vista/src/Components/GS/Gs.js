    ...
    return(
        <div className='box' align = "center">
            <form className='form' onSubmit={hSub}>
                ...
                <br/>
                <Button onClick={()=>{navi('/')}} color='inherit' variant='outlined' sx={{":hover":{backgroundColor:'rgb(237, 232, 232)', color:'purple'} ,color:'white', backgroundColor:'purple'}}>SIGN Up</Button>
                <br/>
            </form>
        </div>
    )
